    ...
    return(
        <div className="relative h-400 flex items-center justify-center">
            ...
            <div className=" hidden lg:h-24  lg:flex lg:flex-row lg:items-center lg:justify-center lg:space-x-14 text-xl text-slate-500 ">
                ...
                <Link href="/getTutor">
                    <a className= {router.pathname === "/getTutor" ? "font-semibold text-cyanblue-300": ""}>Get Tutor</a>
                </Link>
                ...
                <Link href="/blog">
                    <a className= {router.pathname === "/blog" ? "font-semibold text-cyanblue-300": ""}>Blog</a>
                </Link>
